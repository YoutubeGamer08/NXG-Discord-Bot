...
intents.message_content = True  # REQUIRED for DM commands
...
# Other DM commands (rename, limit, mute, deafen) remain the same
# ... copy your existing code here ...

# --- Run Bot ---
if __name__ == "__main__":
    TOKEN = os.getenv("DISCORD_TOKEN")  # make sure this is set on Render
    if not TOKEN:
        raise ValueError("⚠️ DISCORD_TOKEN environment variable not set.")
    bot.run(TOKEN)
